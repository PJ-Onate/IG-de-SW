...
const router = useRouter()
  ...
  return (
    ...
    <Heading as="H2" textAlign={"center"} size="md" color={"blue"}>Seleccione la opcion que desea utilizar</Heading>
      ...
      <Button colorScheme="blue" mt="20" mb="10" onClick={()=>router.push('./listadoVecinos')}>Listado de Clientes</Button>
      <Button colorScheme="blue" mt="20" mb="10" onClick={()=>router.push('./menuPrincipal')}>Ingresar Boleta</Button>
      <Button colorScheme="blue" mt="20" mb="10" onClick={()=>router.push('./menuPrincipal')}>Buscar boleta</Button>
